...
//        player.effectSkill.timeAnTroi = timeAnTroi;
    ...
    public void setIsBroly(Player player) {
        ...
        case 0:
            RadarService.gI().setIDAuraEff(player, 7);
            break;
        case 1:
            RadarService.gI().setIDAuraEff(player, 66);
            break;
        case 2:
            RadarService.gI().setIDAuraEff(player, 7);
            break;
...
//        player.effectSkill.timetienhoa = SkillUtil.getTimetienhoa(lastLevel, template.coolDown);
       ...
       switch (player.gender) {
                case 0:
                    switch (player.isbroly) {
                        case 1:
                            RadarService.gI().setIDAuraEff(player, 63);
                            break;
                        case 2:
                            RadarService.gI().setIDAuraEff(player, 71);
                            break;
                        case 3:
                            RadarService.gI().setIDAuraEff(player, 72);
                            break;
                        case 4:
                            RadarService.gI().setIDAuraEff(player, 70);
                            break; 
                        default:
                    }
                    break;
                case 1:
                    switch (player.isbroly) {
                        case 1:
                            ...
                            break;
                        case 2:
                            RadarService.gI().setIDAuraEff(player, 67);

                            break;
                        case 3:
                            RadarService.gI().setIDAuraEff(player, 68);
                            break;
                        case 4:
                            RadarService.gI().setIDAuraEff(player, 66);
                            break;
                ...
                case 2:
                    switch (player.isbroly) {
                        case 1:
                            ...
                            break;
                        case 2:
                            RadarService.gI().setIDAuraEff(player, 64);
                            break;
                        case 3:
                            RadarService.gI().setIDAuraEff(player, 72);
                            break;
                        case 4:
                            RadarService.gI().setIDAuraEff(player, 69);
                            break;    
                    }
        default:
            break;
