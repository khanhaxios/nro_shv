            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Để tới Nghĩa Trang cần có vé du hành\n" + "Thời gian còn lại có thể tới là " + Util.tinhgio(player.thoigianduhanh), "Đến vũ trụ\nNghĩa Trang");
                    }
                }
            }
                            ...
                            switch (select) {
                                ...
                                case 1:
                                    ...
                                    if (sanho == null || sanho.quantity < 99) {
                                        ...
                                        this.npcChat(player, "Bạn không đủ x5 thỏi kim tệ");
                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (SaoBien == null || SaoBien.quantity < 99) {
                                        ...
                                        this.npcChat(player, "Bạn không đủ 200tr kim tệ");
                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                ...
                                case 2:
                                    ...
                                    if (VoSo == null || VoSo.quantity < 99) {
                                        ...
                                        this.npcChat(player, "Bạn không đủ 1 Tỷ kim tệ");
                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        player.inventory.gold -= 200_000_000;
                            ...
                            switch (select) {
                                ...
                                case 3:
                                    ...
                                    if (VoOc == null || VoOc.quantity < 999) {
                                        ...
                                        this.npcChat(player, "Bạn nhận được 1 thỏi kim tệ");
                                    }
                                    break;
                            }
                        }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    ShopServiceNew.gI().opendShop(player, "TUI_VO_HANG_2", true);
                                    break;
                            }
                        }
                    }
...
//                            + " x999 Vỏ Ốc: Thỏi Kim tệ (Có thể đổi số lượng lớn)\n",
//                            "Đổi\nSao Biển", "Đổi\nCon Cua","Đổi\nVỏ Sò","Đổi\nVỏ Ốc");
//                        break;
//                        case 2:
...
//                            + "\n|7|Làm bánh sẽ tốn phí 2Ty Kim tệ/lần"
...
//                            + "\nToàn bộ máy chủ được nhân đôi số kim tệ rơi ra từ quái,thời gian còn lại "
//                            + "5" + " phút."
//                            + "\nKhi tặng đủ 999 bông hoa toàn bộ máy chủ được nhân đôi số kim tệ rơi ra từ quái trong 60 phút",
//                            "Tặng 1\n Bông hoa", "Tặng\n10 Bông", "Tặng\n99 Bông",
//                            "Đổi\nHộp quà");
//                        break;
//                        case 6:
...
//                                            this.npcChat(player, "|7|Bạn không đủ 2Ty Kim tệ");
//                                        } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
...
//                                        throw new RuntimeException(e);
                        ...
                        switch (select) {
                            case 0: {
                                ...
                                if (player.diemtrungthu < 500) {
                                    ...
                                    InventoryServiceNew.gI().addItemBag(player, thegh);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 200 " + manhthiensu.template.name + ", 50 Rương thần linh, 30 Hộp Bánh Trưng, 30 Thẻ gia hạn, 1 Phiếu giảm giá và 250k Hồng ngọc");
                                }
                                break;
                            }
                            case 1: {
                                ...
                                if (player.diemtrungthu < 300) {
                                    ...
                                    InventoryServiceNew.gI().addItemBag(player, thegh);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 100 " + manhthiensu.template.name + ", 40 Rương thần linh, 15 Hộp Bánh trưng, 10 Thẻ gia hạn và 150k Hồng ngọc");
                                }
                                break;
                            }
                            case 2: {
                                ...
                                if (player.diemtrungthu < 200) {
                                    ...
                                    InventoryServiceNew.gI().addItemBag(player, thegh);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 50 " + manhthiensu.template.name + ", 30 Rương thần linh, 10 Hộp Bánh trưng, 5 Thẻ gia hạn và 100k Hồng ngọc");
                                }
                                break;
                            }
                            case 3: {
    ...
    public static Npc Pic2Mai(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (this.mapId == 7) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7|Hiện Tại Bạn Đang Đang Có Số Điểm Sự Kiện Là " + player.NguHanhSonPoint + "\nĐể Đổi Hộp Qùa Sự Kiện Hè Bạn Cần 99 San Hô + 99 Bình Nước + 99 Khúc Gỗ + 1 Que Diêm + 5 Thỏi Kim tệ. Bạn Sẽ Nhận Được Hộp Qùa VIP Và Điểm Sự Kiện. Ngoài Ra Bạn Có Thể Sử Dụng X99 Nguyên Liệu Mỗi Loại Kết Hợp Với 1 Que Diêm Để Nhận Được Hộp Qùa Thường Và Điểm Sự Kiện.", "Đổi \n Hộp Qùa VIP", "Đổi \n Hộp Qùa VIP");
...
//                                        throw new RuntimeException(e);
                                    ...
                                    if (sanho == null || sanho.quantity < 99 || binhnuoc == null || binhnuoc.quantity < 99 || khucgo == null || khucgo.quantity < 99 || quediem == null || quediem.quantity < 1) {
                                        ...
                                        this.npcChat(player, "Bạn không đủ thỏi kim tệ");
                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, sanho, 99);
...
//                                        throw new RuntimeException(e);
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (khungtre == null || khungtre.quantity < 1000) {
                                    ...
                                    this.npcChat(player, "Bạn còn thiếu x1 Thỏi kim tệ");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                    this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                } else {
                            ...
                            case 3:
                                //     if (Manager.SUKIEN == 2) {
                                this.createOtherMenu(player, ConstNpc.MENUSUKIENGIOTO, "Con muốn đổi dưa hấu hả", "1 quả 10 thỏi kim tệ", "5 quả 70 thỏi kim tệ", "10 quả 200 thỏi kim tệ", "15 quả 350 thỏi kim tệ", "20 quả 500 thỏi kim tệ", "25 quả 700 thỏi kim tệ", "Đóng");
                                //      } else {
                                //         Service.getInstance().sendThongBao(player, "Sự kiện đã kết thúc");
                                //     }
                                break;
            ...
            public void openBaseMenu(Player player) {
                if (this.mapId == 5) {
                    if (NauBanh.gI().NauXong == true) {
                        this.createOtherMenu(player, 0, "Bánh đã chín, Bạn có " + Util.tinhgio(NauBanh.gI().ThoiGianChoLayBanh) + " để lấy\n|2|Nếu offline số bánh có thể được lấy vào đợt sau!", "Lấy Bánh");
    ...
    public static Npc Vodai(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player pl) {
                if (canOpenNpc(pl)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(pl, ConstNpc.BASE_MENU, "|1|Ta Có Thể Giúp Gì Cho Ngươi?", "Đến Võ Đài Bà Hạt Mít", "Từ chối");
                    } else if (this.mapId == 112) {
                        int goldchallenge = pl.goldChallenge;
                        if (pl.levelWoodChest == 0) {
                            menuselect = new String[]{"Thi đấu\n" + Util.numberToMoney(goldchallenge) + " kim tệ", "Về Đảo Kame"};
                        } else {
                            menuselect = new String[]{"Thi đấu\n" + Util.numberToMoney(goldchallenge) + " kim tệ", "Nhận thưởng\nRương cấp\n" + pl.levelWoodChest, "Về Đảo Kame"};
                        }
                                ...
                                case 0:
                                    if (InventoryServiceNew.gI().finditemWoodChest(player)) {
                                        if (player.inventory.gold >= goldchallenge) {
                                            ...
                                            Service.getInstance().sendThongBao(player, "Không đủ kim tệ, còn thiếu " + Util.numberToMoney(goldchallenge - player.inventory.gold) + " kim tệ");
                                        }
                                    } else {
    ...
    public static Npc vihop(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU, "Xin chào, ta có một số vật phẩm đặt biệt cậu có muốn xem không?", "Đổi Đệ Vip");
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(player, ConstNpc.BUY_DE_TU_VIP, "Xin chào, ta có một số bé pet vip nè!\n|1|Số công đức của bạn còn : " + player.congduc + "\n|7|Đệ Nguyệt Thần: 30k công đức, Hợp thể tăng 30% chỉ số" + "\n|7|Đệ Nhật Thần: 40k công đức, Hợp thể tăng 40% chỉ số" + "\n|7|Đệ Kaido: 50k công đức, Hợp thể tăng 50% chỉ số" + "\n|7| Lưu Ý Phải Có Đệ Thường Mới Mua Được Đệ Vip", "Nhật Thần", "Nguyệt Thần", "Kaido");
                                    break;
                            }
                            ...
                            try (Connection con = GirlkunDB.getConnection();) {
                                switch (select) {
                                    case 0:
                                        if (player.congduc < 30000) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 30k công đức");
                                            return;
                                        }
                                        if (player.pet == null) {
                                        ...
                                        player.congduc -= 30000;
                                        PetService.gI().createPetNguyetThan(player, true, player.pet.gender);
                                        break;
                                    case 1:
                                        if (player.congduc < 40000) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 40k công đức");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                                        ...
                                        player.congduc -= 40000;
                                        PetService.gI().createPetNhatThan(player, true, player.pet.gender);
                                        break;
                                    case 2:
                                        if (player.congduc < 50000) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 50k công đức");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                        ...
                        try {
                            ...
                            if (this.mapId == 19) {
                                ...
                                if (now > MapSatan.TIME_OPEN_SATAN && now < MapSatan.TIME_CLOSE_SATAN) {
                                    this.createOtherMenu(player, ConstNpc.MENU_OPEN_SANTA, "Đại chiến Hirudegan đã mở, " + "ngươi có muốn tham gia không?", "Hướng dẫn\nthêm", "Tham gia", "Từ chối");
                                } else {
                                    this.createOtherMenu(player, ConstNpc.MENU_NOT_OPEN_SANTA, "Ta có thể giúp gì cho ngươi?", "Hướng dẫn", "Cửa Hàng", "Từ chối");
                                }
                            ...
                            case ConstNpc.MENU_NOT_OPEN_BDW:
                                ...
                                if (select == 1) {
                                    if (player.nPoint.power >= 2000000000) {
                                        ...
                                        Service.gI().sendThongBaoOK(player, "Yêu cầu 2 tỉ sức mạnh");
    ...
    private static Npc gapthu(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, 1234, "|7|- •⊹٭Ngọc Rồng Online٭⊹• -\nMÁY GẮP LINH THÚ\n" + "|3|GẮP THƯỜNG : 10-50% CHỈ SỐ\nGẮP CAO CẤP : 50-85% CHỈ SỐ\nGẮP VIP : 85-100% CHỈ SỐ" + "\nGẮP X1 : GẮP THỦ CÔNG\nGẮP X10 : AUTO X10 LẦN GẮP\nGẮP X100 : AUTO X100 LẦN GẮP\n" + "|7|LƯU Ý : MỌI CHỈ SỐ ĐỀU RANDOM KHÔNG CÓ OPTION NHẤT ĐỊNH\nNẾU MUỐN NGƯNG AUTO GẤP CHỈ CẦN THOÁT GAME VÀ VÀO LẠI!", "Gắp Thường", "Gắp Cao Cấp", "Gắp VIP", "Mua xu", "Xem Top", "Rương Đồ");
                    }
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.getIndexMenu() == 1234) {
                            ...
                            switch (select) {
                                case 0:
                                    if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 1394) == null) {
                                        this.createOtherMenu(player, 12345, "|7|HẾT XU!", "Gắp X1", "Gắp X10", "Gắp X100", "Rương Đồ");
                                        break;
                                    }
                                    try {
                            ...
                            switch (select) {
                                case 0:
                                    if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 1395) == null) {
                                        this.createOtherMenu(player, 12346, "|7|HẾT XU!", "Gắp X1", "Gắp X10", "Gắp X100", "Rương Đồ");
                                        break;
                                    }
                                    try {
                                        Service.gI().sendThongBao(player, "Tiến hành auto gắp x1 lần");
                                        ...
                                        while (timex1 > 0) {
                                            ...
                                            player.point_gapthu += 1;
                                            short[] bkt = {1463, 1464, 1465, 1466, 1467};
                                ...
                                case 1:
                                    ...
                                    try {
                                        ...
                                        while (timex10 > 0) {
                                            ...
                                            player.point_gapthu += 1;
                                            short[] bkt = {1463, 1464, 1465, 1466, 1467, 1468};
                                ...
                                case 2:
                                    ...
                                    try {
                                        ...
                                        while (timex100 > 0) {
                                            ...
                                            player.point_gapthu += 1;
                                            short[] bkt = {1463, 1464, 1465, 1466, 1467, 1468, 1469};
                            ...
                            switch (select) {
                                case 0:
                                    if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 1396) == null) {
                                        this.createOtherMenu(player, 12347, "|7|HẾT XU!", "Gắp X1", "Gắp X10", "Gắp X100", "Rương Đồ");
                                        break;
                                    }
                                    try {
                                        Service.gI().sendThongBao(player, "Tiến hành auto gắp x1 lần");
                                        ...
                                        while (timex1 > 0) {
                                            timex1--;
                                            count++;
                                            InventoryServiceNew.gI().subQuantityItemsBag(player, InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 1396), 2);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            Thread.sleep(100);
                                            if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 1396) == null) {
                                            ...
                                            player.point_gapthu += 1;
                                            short[] bkt = {1463, 1464, 1465, 1466, 1467, 1468, 1469, 1470, 1471, 1472, 1473, 1474, 1475};
                                ...
                                case 2:
                                    ...
                                    try {
                                        ...
                                        while (timex100 > 0) {
                                            ...
                                            player.point_gapthu += 1;
                                            short[] bkt = {1463, 1464, 1465, 1466, 1467, 1468, 1469, 1470, 1471, 1472, 1473, 1474, 1475, 1489, 1490, 1454, 1458, 1393, 1317, 1318};
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, 2221, "|7|Ở dây ta có bán XU thường\n" + "|5|Ta hỗ trợ mua với số lượng lớn quy định như sau:\n" + "|5|10 Xu thường = 10 Thỏi kim tệ\n" + "|5|105 Xu thường = 100 Thỏi kim tệ\n" + "|5|1100 Xu thường = 1000 Thỏi kim tệ\n" + "|3|Ngươi muốn mua số lượng bao nhiêu?", "" + "Mua 15 Xu", "Mua 150 Xu", "Mua 1600 Xu");
                                    break;
                                case 1:
                                    this.createOtherMenu(player, 2222, "|7|Ở dây ta có bán XU cao cấp\n" + "|1|Giá Nước hoa tại Cửa hàng Santa: 500Tr kim tệ\n" + "|5|Ta hỗ trợ mua với số lượng lớn quy định như sau:\n" + "|5|10 Xu cao cấp = 15 Thỏi kim tệ\n" + "|5|105 Xu cao cấp = 150 Thỏi kim tệ\n" + "|5|1500 Xu cao cấp = 1400 Thỏi kim tệ\n" + "|3|Ngươi muốn mua số lượng bao nhiêu?", "" + "Mua 13 Xu", "Mua 135 Xu", "Mua 1400 Xu");
                                    break;
                                case 2:
                                    this.createOtherMenu(player, 2223, "|7|Ở dây ta có bán XU Vip\n" + "|1|Giá Nước hoa tại Cửa hàng Santa: 500Tr kim tệ\n" + "|5|Ta hỗ trợ mua với số lượng lớn quy định như sau:\n" + "|5|10 Xu vip = 50 Thỏi kim tệ\n" + "|5|105 Xu vip = 500 Thỏi kim tệ\n" + "|5|1100 Xu vip = 5000 Thỏi kim tệ\n" + "|3|Ngươi muốn mua số lượng bao nhiêu?", "" + "Mua 10 Xu", "Mua 105 Xu", "Mua 1110 Xu");
                                    break;
                            }
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (tv == null || tv.quantity < 10) {
                                        this.npcChat(player, "Con còn thiếu x10 thỏi kim tệ");
                                ...
                                case 1:
                                    ...
                                    if (tv1 == null || tv1.quantity < 100) {
                                        this.npcChat(player, "Con còn thiếu x100 thỏi kim tệ");
                                ...
                                case 2:
                                    ...
                                    if (tv2 == null || tv2.quantity < 1000) {
                                        this.npcChat(player, "Con còn thiếu x1000 thỏi kim tệ");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv2, 1000);
                                        Item capsule = ItemService.gI().createNewItem((short) 1394, 1000);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (tv == null || tv.quantity < 15) {
                                        ...
                                        Item capsule = ItemService.gI().createNewItem((short) 1395, 10);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        player.point_gapthu += 15;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được Nước hoa");
                                    }
                                    break;
                                case 1:
                                    ...
                                    if (tv1 == null || tv1.quantity < 150) {
                                        this.npcChat(player, "Con còn thiếu x100 thỏi kim tệ");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv1, 150);
                                        Item capsule = ItemService.gI().createNewItem((short) 1395, 100);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        player.point_gapthu += 150;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được Nước hoa");
                                    }
                                    break;
                                case 2:
                                    ...
                                    if (tv2 == null || tv2.quantity < 1500) {
                                        this.npcChat(player, "Con còn thiếu x1000 thỏi kim tệ");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv2, 1500);
                                        Item capsule = ItemService.gI().createNewItem((short) 1395, 1000);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        player.point_gapthu += 1500;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được Nước hoa");
                                    }
                                    break;
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (tv == null || tv.quantity < 50) {
                                        this.npcChat(player, "Con còn thiếu x50 thỏi kim tệ");
                                ...
                                case 1:
                                    ...
                                    if (tv1 == null || tv1.quantity < 500) {
                                        this.npcChat(player, "Con còn thiếu x500 thỏi kim tệ");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv1, 500);
                                        Item capsule = ItemService.gI().createNewItem((short) 1396, 100);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        player.point_gapthu += 500;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được Nước hoa");
                                    }
                                    break;
                                case 2:
                                    ...
                                    if (tv2 == null || tv2.quantity < 5000) {
                                        this.npcChat(player, "Con còn thiếu x1000 thỏi kim tệ");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv2, 5000);
                                        Item capsule = ItemService.gI().createNewItem((short) 1396, 1000);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        player.point_gapthu += 1000;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được Nước hoa");
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.CONFIRM_REMOVE_ALL_ITEM_LUCKY_ROUND, this.avartar, "|3|Bạn chắc muốn xóa hết vật phẩm trong rương phụ?\n" + "|7|Sau khi xóa sẽ không thể khôi phục!", "Đồng ý", "Hủy bỏ");
                                    break;
                            }
                        }
                    }
    ...
    public static Npc miNuong(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.MENU_JOIN_GIAI_CUU_MI_NUONG, "Ta đang bị kẻ xấu lợi dụng kiểm soát bản thân\n" + "Các chàng trai hãy cùng nhau nhanh chóng tập hợp lên đường giải cứu ta", "Tham gia", "Hướng dẫn", "Từ chối");
                }
            }
                ...
                try {
                    ...
                    if (this.mapId == 13) {
                        ...
                        if (now > MapVodai.TIME_OPEN_VODAI && now < MapVodai.TIME_CLOSE_VODAI) {
                            ...
                            this.createOtherMenu(player, ConstNpc.MENU_OPEN_VODAI, "Đại chiến ngọc rồng namec đã mở, " + "ngươi có muốn tham gia không?\n\n" + "|7|Hiện tại đã có " + numRegistered + " người đăng ký tham gia.", "Hướng dẫn\nthêm", "Đăng ký", "Tham gia", "Từ chối");
                        } else {
                            this.createOtherMenu(player, ConstNpc.MENU_NOT_OPEN_VODAI, "Ta có thể giúp gì cho ngươi?", "Hướng dẫn", "Từ chối");
                        }
                    } else if (this.mapId == 166) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ta có thể giúp gì cho ngươi?", "Nhận thưởng", "Quay về");
                    }
                } catch (Exception ex) {
    ...
    private static Npc trungLinhThu(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 104) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Đổi Trứng Linh thú cần:\b|7|X99 Hồn Linh Thú + 1 Tỷ kim tệ", "Đổi Trứng\nLinh thú", "Nâng Chiến Linh", "Mở chỉ số ẩn\nChiến Linh", "Từ chối");
                    }
                }
            }
...
//                            switch (player.combineNew.typeCombine) {
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void confirmMenu(Player pl, int select) {
                if (canOpenNpc(pl)) {
                    switch (select) {
                        case 0:
                            Service.gI().sendPopUpMultiLine(pl, tempId, avartar, "Cửa hàng chuyên nhận ký gửi mua bán vật phẩm\bChỉ với 5 hồng ngọc\bGiá trị ký gửi 10k-200Tr kim tệ hoặc 2-2k ngọc\bMột người bán, vạn người mua, mại dô, mại dô");
                            break;
                        case 1:
    ...
    private static Npc poTaGe(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 140) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Đa vũ trụ song song \b|7|Con muốn gọi con trong đa vũ trụ \b|1|Với giá 200tr kim tệ không?", "Gọi Boss\nNhân bản", "Từ chối");
                    }
                }
            }
                            ...
                            switch (select) {
                                case 0: {
                                    ...
                                    if (oldBossClone != null) {
                                        ...
                                        this.npcChat(player, "Nhà ngươi không đủ 200 Triệu kim tệ ");
                                    } else {
                                        ...
                                        BossData bossDataClone = new BossData("Nhân Bản" + player.name, player.gender, new short[]{player.getHead(), player.getBody(), player.getLeg(), player.getFlagBag(), player.idAura, player.getEffFront()}, player.nPoint.dame, new long[]{player.nPoint.hpMax}, new int[]{140}, skillTemp, new String[]{"|-2|Boss nhân bản đã xuất hiện rồi"}, //text chat 1
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        ...
                        if (player.getSession().is_gift_box) {
                            ...
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Nói chuyện", "Sự kiện", "Hồi Skill\nNhanh", "Từ chối");
                        }
                    }
                }
            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                createOtherMenu(player, ConstNpc.NOICHUYEN, "Ngươi tìm ta có việc gì?\n", "Chức năng\nbang hội", "Bản Đồ Kho Báu", "Đóng");
                                break;
                            case 1:
                                createOtherMenu(player, ConstNpc.SU_KIEN, "Ngươi tìm ta có việc gì?\n", "Đổi quà\nsự kiện", "Đổi\nKhăn quàng", "Từ chối");
                                break;
                            case 2:
                                this.createOtherMenu(player, ConstNpc.HOI_SKILL, "Đưa ta 1 thỏi kim tệ để hồi skill cấp tốc" + "\n|1|Lưu ý: Ấn vào skill muốn hồi rồi ấn đồng ý, chỉ hồi 1 skill chỉ định" + "\n|2| Chúc bạn chơi game vui vẻ", "Đồng ý", "Từ chối");
                                break;
                        }
                        ...
                        switch (select) {
                            case 0:
                                Item item = InventoryServiceNew.gI().findItemBag(player, 457);
                                if (item.isNotNullItem() && item.quantity >= 1) {
                                    ...
                                    // Thông báo hồi skill
                                    Service.gI().sendThongBaoOK(player, "Con đã hồi skill rồi");
                                } else {
                                    Service.gI().sendThongBaoOK(player, "Con không đủ thỏi kim tệ, hãy nạp thêm kim tệ tại Santa nhé!!");
                                }
                                break;
                        ...
                        switch (select) {
                            case 0:
                                this.createOtherMenu(player, ConstNpc.MENU_NHAP_HOC, "Mừng khai giảng năm học mới, ta có một số phần quà dành cho con!", "Quà cấp tiểu học", "Quà cấp đại học", "Nhận danh hiệu\nBé ngoan");
                                break;
                            case 1:
                        ...
                        switch (select) {
                            case 0:
                                giavang = 20000000;
                                if (items[0] != null && items[1] != null && items[0].quantity >= 30 && items[1].quantity >= 30 && player.inventory.gold >= giavang) {
                                    ...
                                    createOtherMenu(player, ConstNpc.IGNORE_MENU, "|1| Đổi Thần Tài\n|2| Khăn đỏ " + quantity1 + "/30\nKhăn quàng " + quantity2 + "/30\n Giá kim tệ: " + Util.formatNumber(giavang), "OK\nTa biết rồi");
                                }
                                break;
                            ...
                            case 1:
                                giavang = 50000000;
                                giaruby = 150;
                                if (items[0] != null && items[1] != null && items[0].quantity >= 50 && items[1].quantity >= 50 && player.inventory.gold >= giavang && player.inventory.ruby >= giaruby) {
                                    player.inventory.gold -= giavang;
                                    ...
                                    createOtherMenu(player, ConstNpc.IGNORE_MENU, "|1| Chế tạo bồn tắm kim tệ\n|2| Khăn đỏ " + quantity1 + "/50\nKhăn quàng " + quantity2 + "/50\n Giá kim tệ: " + Util.formatNumber(giavang) + "\nGiá Hồng ngọc: " + giaruby, "OK\nTa biết rồi");
                                }
                                break;
                            case 2:

                                if (items[2] != null && items[3] != null && items[2].quantity >= 10 && items[3].quantity >= 10) {
                                    ...
                                    createOtherMenu(player, ConstNpc.IGNORE_MENU, "|1| Danh hiệu bé ngoan:\n|2| Phiếu bé ngoan: " + quantity3 + "/10\nĐiểm 10: " + quantity4 + "/10", "OK\nTa biết rồi");
                                }
                                break;
                        }
                        ...
                        switch (select) {
                            case 0:
                                createOtherMenu(player, ConstNpc.BANGHOI, "Ngươi tìm ta có việc gì?\n", "Giải tán\nbang hội", "Khu Vực\nBang Hội", "Nâng cấp\nBang hội", "Quyên góp");
                                break;
                            case 1:
                                if (player.clan == null) {
                                    this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Vào bang hội trước", "Đóng");
                                    break;
                                }
                                if (player.clan.banDoKhoBau != null) {
                                    createOtherMenu(player, ConstNpc.MENU_OPENED_DBKB, "Bang hội của con đang tham gia Bản đồ kho báu cấp độ " + player.clan.banDoKhoBau.level + "\n" + "Thời gian còn lại là " + TimeUtil.getSecondLeft(player.clan.banDoKhoBau.getLastTimeOpen(), BanDoKhoBau.TIME_BAN_DO_KHO_BAU / 1000) + " giây. Con có muốn tham gia không?", "Tham gia", "Không");
                                    break;
                                }
                        ...
                        switch (select) {
                            case 0:
                                if (player.clan.capsuleClan >= 1000 && clan.isLeader(player) && player.inventory.gold >= 1000000000L) {
                                    ...
                                    Service.gI().sendThongBaoOK(player, "Bạn còn thiều " + (1000000000L - player.inventory.gold) + " kim tệ");
                                    return;
                        ...
                        switch (select) {
                            case 0:
                                if (player.isAdmin() || player.nPoint.power >= BanDoKhoBau.POWER_CAN_GO_TO_DBKB) {
                                    ...
                                    this.npcChat(player, "Sức mạnh của con phải ít nhất phải đạt " + Util.numberToMoney(BanDoKhoBau.POWER_CAN_GO_TO_DBKB));
                                }
                                break;
                        }
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_4_3) {
                            TaskService.gI().sendNextTaskMain(player);
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Tốt lắm, con hoàn thành rất xuất xắc", "Đóng");
                        } else if (TaskService.gI().getIdTask(player) == ConstTask.TASK_10_1) {
                            TaskService.gI().sendNextTaskMain(player);
                        }
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7|Chào con thầy còn dữ lại " + Util.format(player.congduc) + "công đức của con! ".replaceAll("%1", player.gender == ConstPlayer.TRAI_DAT ? "Quy lão Kamê" : player.gender == ConstPlayer.NAMEC ? "Trưởng lão Guru" : "Vua Vegeta"), "Hỗ Trợ", "Điểm danh", "Nhận mốc\n tích lũy", "Nhận Đệ\nMiễn Phí", "GiftCode");//, "Mốc Nạp");
                    }
                }
            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                createOtherMenu(player, ConstNpc.HOTRO, "|7|Hỗ Trợ Player\n|2|Đối Với Phần Next Nhiệm Vụ\n|2|Bạn Sẽ Được Next Nhiệm Vụ Dến Nappa", "Nhận Ngọc Xanh", "Next Nhiệm Vụ");
                                break;
                            case 1:
                                if (!player.getSession().actived) {
                                    Service.gI().sendThongBao(player, "Vui lòng kích hoạt tài khoản để sử dụng chức năng này");
                                    ...
                                    int thoivang1;
                                    if (player.congduc >= 0 && player.congduc < 100000) {
                                        thoivang1 = 10;
                                    } else if (player.congduc > 1000000 && player.congduc < 5000000) {
                                        thoivang1 = 50;
                                    } else {
                                        thoivang1 = 120;
                                    }
                                    ...
                                    Service.getInstance().sendThongBao(player, "|5|Bạn vừa nhận được " + thoivang1 + " Thỏi kim tệ");
                                } else {
                                    this.npcChat(player, "|5|Hôm nay đã nhận rồi mà !!!");
                                }
                                break;
                            case 2:
                                createOtherMenu(player, ConstNpc.NAPTICHLUY, "|7|Nhận quà tích lũy công đức.", "");
                                break;
                            case 3:
                                if (player.pet == null) {
                        ...
                        switch (select) {
                            case 0:
                                try {
                                    if (player.congduc >= 50000 && player.mocnap == 0) {
                                        if (player.gender == 0) {
                                        ...
                                        Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Tích Lũy 50K");
                                        player.congduc -= 50000;
                                        Thread.sleep(3000);
                                        Service.gI().sendThongBao(player, "Bạn Đã Nhận Được một set thần linh");
                                        player.mocnap = 1;
                                    } else {
                                        this.npcChat(player, "Bạn đã nhận mốc tích lũy 50k công đức rồi" + "\nHãy Tích Lũy Thêm Để Nhận Mốc 500k");
                                    }
                            ...
                            case 1:
                                try {
                                    if (player.congduc >= 500000 && player.mocnap == 1) {
                                        ...
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Tích Lũy 500k");
                                        Thread.sleep(3000);
                                        player.congduc -= 500000;
                                        player.mocnap = 2;
                                        Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + cc.template.name);
                                    } else {
                                        if (player.congduc < 500000) {
                                            Service.gI().sendThongBaoOK(player, "Bạn không đủ 500k công đức hãy tích lũy thêm");
                                        } else {
                                            this.npcChat(player, "Bạn đã nhận mốc tích lũy 500k" + "\nHãy Tích Lũy Thêm Để Nhận Mốc 1000k");
                                        }
                                    }
                                } catch (Exception DM_BKT) {
                            ...
                            case 2:
                                try {
                                    if (player.congduc >= 1000000 && player.mocnap == 2) {
                                        int[] itGangTs = new int[]{1054, 1055, 1056};
                                        Item doTs = ItemService.gI().DoThienSu(itGangTs[player.gender], player.gender);
                                        doTs.itemOptions.add(new Item.ItemOption(30, 0));
                                        InventoryServiceNew.gI().addItemBag(player, doTs);
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Tích Lũy 1000k");
                                        Thread.sleep(3000);
                                        player.congduc -= 1000000;
                                        player.mocnap = 3;
                                        Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + doTs.template.name);
                                    } else {
                                        if (player.congduc < 1000000) {
                                            Service.gI().sendThongBaoOK(player, "Bạn không đủ 1000k công đức hãy tích lũy thêm");
                                        } else {
                                            this.npcChat(player, "Bạn đã nhận mốc tích lũy 1000k" + "\nĐã nhận hết mốc tích lũy rồi");
                                        }
                                    }
                                } catch (Exception DM_BKT) {
                                }
                        ...
                        switch (select) {
                            case 0:
                                ...
                                break;
                            case 1:
                                if (player.playerTask.taskMain.id > 0 && player.playerTask.taskMain.id <= 17) {
    ...
    public static Npc SuPhu(int mapId, int status, int cx, int cy, int tempId, int avatar) {
        return new Npc(mapId, status, cx, cy, tempId, avatar) {

            public void npcChat(Player player) {
                String[] chatMessages = {"Giúp Ta đẫn Hổ mập Về Nhà", "Em buông tay anh vì lí do gì ", "Người hãy nói đi, đừng Bắt Anh phải nghĩ suy"};
                ...
                chatTimer.scheduleAtFixedRate(new TimerTask() {
                    ...
                    @Override
                    public void run() {
                        npcChat(player, chatMessages[index]);
                        index = (index + 1) % chatMessages.length;
                    }
                }, 6000, 6000);
            }
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        String menuText = String.format("Cậu cần thỉnh kinh thì tới chỗ tôi nhé\b|7|Bạn Đang Có\n%d Điểm Công Đức Hộ Tống", player.diemhotong);
                        createOtherMenu(player, ConstNpc.BASE_MENU, menuText, "Hộ tống", "Mua Đá", "Cửa hàng\nHộ tống", "TOP Hộ Tống", "hướng dẫn\nhộ tống");
                    }
                }
            }

            @Override
            public void confirmMenu(Player player, int selection) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu()) {
                        handleBaseMenuSelection(player, selection);
                    } else if (player.iDMark.getIndexMenu() == ConstNpc.MUA_XU) {
                        handleMuaXuSelection(player, selection);
                    }
                }
            }

            private void handleBaseMenuSelection(Player player, int selection) {
                switch (selection) {
                    case 0:
                        handleHoTongSelection(player);
                        break;
                    case 1:
                        createMuaXuMenu(player);
                        break;
                    case 2://Shop
            ...
            private void handleHoTongSelection(Player player) {
                Boss oldDuongTank = BossManager.gI().getBossById(Util.createIdDuongTank((int) player.id));
                if (oldDuongTank != null) {
                    npcChat(player, " Bumma đang được hộ tống" + oldDuongTank.zone.zoneId);
                } else if (player.congduc < 300) {
                    npcChat(player, "Nhà ngươi không đủ 300 công đúc");
                } else {
                    createDuongTank(player);
                    player.congduc -= 300;
                    Service.getInstance().sendMoney(player);
                }
            }

            private void createDuongTank(Player player) {
                BossData bossData = new BossData("Bunma do " + player.name + " hộ tống", (byte) 2, new short[]{467, 468, 469, -1, -1, -1}, 100000, new long[]{player.nPoint.hpMax * 2}, new int[]{103}, new int[][]{{Skill.TAI_TAO_NANG_LUONG, 7, 15000}}, new String[]{}, new String[]{}, new String[]{}, 60);
                try {
                    DuongTank dt = new DuongTank(Util.createIdDuongTank((int) player.id), bossData, player.zone, player.location.x - 20, player.location.y);
                    dt.playerTarger = player;
                    int[] maps = {122, 123, 124};
                    dt.mapCongDuc = maps[Util.nextInt(maps.length)];
            ...
            private void createMuaXuMenu(Player player) {
                String menuText = "|1|Ở đây ta có bán Đá Ngũ Sắc Đỏ\n" + "|5|10 Đá = 1 CDHT\n" + "|5|105 Đá = 10 CDHT\n" + "|5|1100 Đá = 100 CDHT\n" + "|3|Ngươi muốn mua số lượng bao nhiêu?";
                createOtherMenu(player, ConstNpc.MUA_XU, menuText, "Mua 10\nĐá", "Mua 105\nĐá", "Mua 1100\nĐá", "Từ chối");
            }

            private void handleMuaXuSelection(Player player, int selection) {
                switch (selection) {
                    case 0:
                        muaXu(player, 1, 10);
                        break;
                    case 1:
                        ...
                        break;
                    case 2:
                        muaXu(player, 100, 1100);
                        break;
                }
            }

            private void muaXu(Player player, int requiredGold, int givenItems) {
                if (player.diemhotong < requiredGold) {
                    npcChat(player, String.format("Con còn thiếu x%d điểm CDHT", requiredGold));
                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                    npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                } else {
                    player.diemhotong -= requiredGold;
                    Item newItem = ItemService.gI().createNewItem((short) 1665, givenItems);
                    InventoryServiceNew.gI().addItemBag(player, newItem);
                    InventoryServiceNew.gI().sendItemBags(player);
                    npcChat(player, String.format("Con nhận được x%d Đá Ngũ Sắc Đỏ", givenItems));
                }
            }
        };
    }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        if (this.mapId == 206) {
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Hãy gia nhập phe chúng tôi để chống lại Fide", "Đổi phe", "Giao ngọc");
                        } else {
                                    ...
                                    if (player.getSession().actived && player.cFlag == 9) {
                                        ...
                                        if (listNro.size() > 0) {
                                            for (Item nro : listNro) {
                                                Service.gI().sendThongBao(player, "Bạn vừa giao " + nro.template.name + " cho Bulma và nhận 1 điểm!");
                                                InventoryServiceNew.gI().subQuantityItemsBag(player, nro, 1);
                                                player.pointNroNamec++;
                                                InventoryServiceNew.gI().sendItemBags(player);
                                            }
                                        } else {
                                            Service.gI().sendThongBao(player, "Cậu không có ngọc rồng !");
                                        }
                                    } else {
                                        Service.gI().sendThongBao(player, "Cậu phải cùng phe mới có thể giao ngọc rồng !");
                                    }
                                    break;
                            }
                        } else {
                            switch (select) {
                                ...
                                case 0:
                                    ...
                                    if (hour >= 14 && hour < 17) {
                                        ...
                                        Service.gI().sendThongBaoFromAdmin(player, "Chỉ mở từ 14h đến 17h !");
                                    }
                                    break;
                                case 1:
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, vodaiBallMessage + "\n Hãy gia nhập với bọn ta, ta sẽ chia cho ngươi 1 nửa hành tinh ", "Đổi phe", "Giao ngọc", "Nhận thưởng");
                    }
                }
            }
                    ...
                    if (!TaskService.gI().checkDoneTaskTalkNpc(pl, this)) {
                        if (pl.playerTask.taskMain.id == 7) {
                            ...
                            if (this.mapId == 19) {
                                ...
                                this.createOtherMenu(pl, ConstNpc.BASE_MENU, "Đây là Vùng đất Thám Hiểm\n" + "Nơi tăng x2 tiềm năng và chứa nhiều vật phẩm quý báu\n" + "Chỉ Đệ tử mới tiêu diệt được Quái\n" + "Ngươi muốn ta giúp gì nữa không?", "Về nhà", "Đóng");
                ...
                if (canOpenNpc(player)) {
                    ...
                    if (this.mapId == 19) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    if (player.getSession().player.nPoint.power >= 41000000000L && player.playerTask.taskMain.id > 26) {
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (boss != null && !boss.isDie()) {
                                        if (player.inventory.gold >= COST_FIND_BOSS) {
                                            ...
                                            Service.gI().sendThongBao(player, "Không đủ kim tệ, còn thiếu " + Util.numberToMoney(COST_FIND_BOSS - player.inventory.gold) + " kim tệ");
                                        }
                                    } else {
                                ...
                                case 3:
                                    ...
                                    if (binhnuoc != null && binhnuoc.quantity > 0 && player.nPoint.power >= 80000000000L) {
                                        ...
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, binhnuoc, 1);
                                        InventoryServiceNew.gI().sendItemBags(player);
                                    } else if (player.nPoint.power < 80000000000L) {
                                        Service.gI().sendThongBao(player, "Yêu cầu sức mạnh trên\n80 tỷ");
                                    } else {
                                        Service.gI().sendThongBao(player, "Yêu cầu cần 1 Bình nước");
                                    }
...
//                                            "Shop Thường", "Shop Công Đức", "Shop Thỏi Kim tệ");
//                                    break;
//
//                                case 1:
...
//                                            + "Muốn quy đổi không", "Quy Đổi\n10.000\n 20 Thỏi Kim tệ", "Quy Đổi\n20.000\n 40 Thỏi Kim tệ", "Quy Đổi\n30.000\n 60 Thỏi Kim tệ", "Quy Đổi\n50.000\n 100 Thỏi Kim tệ", "Quy Đổi\n100.000 \n200 Thỏi Kim tệ", "Đóng");
//                                    break;
//
//                            }
//
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    this.createOtherMenu(player, ConstNpc.DOI_CAI_TRANG_CONG_DUC, "|7|Số công đúc của bạn còn : " + player.congduc + " công đức\n" + "\n|1|Cải trang 200-666% chỉ số = 5M công đức (HSD vĩnh viễn)" + "\n|2|Trang bị công đức chỉ số từ 30-100k(Có tỷ lệ) = 1M công đức" + "\n|3|Linh thú công đức chỉ số từ 100-200% (Có tỷ lệ) = 1M công đức" + "\n|4|Cánh công đức chỉ số từ 100-200%(Có tỷ lệ) = 1M công đức", "Đổi \n cải trang", "Đổi \ntrang bị", "Đổi \nLinh thú", "Đổi cánh");
                                    break;
                                case 3:
                                    if (player.getSession().actived) {
                                        Service.gI().sendThongBao(player, "Bạn đã mở rồi");
                                    } else {
                            ...
                            switch (select) {
                                case 0:
                                    if (player.congduc < 20000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 20k Công đức");
                                        return;
                                    }
                                    player.congduc = player.congduc - 20000;
                                    Item i = ItemService.gI().createNewItem((short) 457, (short) 200);
                                ...
                                case 1:
                                    if (player.congduc < 50000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 50k công đức");
                                        return;
                                    }
                                    player.congduc = player.congduc - 50000;
                                    Item i2 = ItemService.gI().createNewItem((short) 457, (short) 500);
                                    InventoryServiceNew.gI().addItemBag(player, i2);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 500 thỏi kim tệ");
                                    break;
                                case 2:
                                    if (player.congduc < 100000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 100k Công đức");
                                        return;
                                    }
                                    player.congduc = player.congduc - 100000;
                                    Item i3 = ItemService.gI().createNewItem((short) 457, (short) 1050);
                                    InventoryServiceNew.gI().addItemBag(player, i3);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 1000 thỏi kim tệ");
                                    break;
                                case 3:
                                    if (player.congduc < 200000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 200k Công đức");
                                        return;
                                    }
                                    player.congduc = player.congduc - 200000;
                                    Item i4 = ItemService.gI().createNewItem((short) 457, (short) 4000);
                                    InventoryServiceNew.gI().addItemBag(player, i4);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 4000 thỏi kim tệ");
                                    break;
                                case 4:
                                    if (player.congduc < 500000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 500k công đức");
                                        return;
                                    }
                                    player.congduc = player.congduc - 500000;
                                    Item i5 = ItemService.gI().createNewItem((short) 457, (short) 8000);
                                    InventoryServiceNew.gI().addItemBag(player, i5);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 8000 thỏi kim tệ");
                                    break;
                                case 5:
                                    if (player.congduc < 1000000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 1000k công đức");
                                        return;
                                    }
                                    player.congduc = player.congduc - 1000000;
                                    Item i6 = ItemService.gI().createNewItem((short) 457, (short) 20000);
                                    InventoryServiceNew.gI().addItemBag(player, i6);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 20000 thỏi kim tệ");
                                    break;
                            }
                                ...
                                case 1:
                                    if (player.Month_Card == 1) {
                                        ...
                                        if (!isAttended && caichogi != player.last_time_dd) {
                                            ...
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            Service.getInstance().sendMoney(player);
                                            Service.gI().sendThongBaoOK(player, "Điểm danh thành công nhận 2.000 hồng ngọc và 10 thỏi kim tệ");
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, 5, "\b|1|Nạp càng nhiều nhận quà càng ngon, mại zô mại zô!" + "\b|5|LƯU Ý: HÃY CHỪA ĐỦ Ô TRỐNG TRONG HÀNH TRANG ĐỂ TRÁNH NHẬN KO ĐỦ ĐỒ, NẾU MẤT ADMIN KO CHỊU TRÁCH NHIỆM!!!" + "\b|7|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND", "Nhận mốc 10k", "Nhận mốc 20k", "Nhận mốc 50k", "Nhận mốc 100k", "Nhận mốc 200k", "Nhận mốc 500k", "Nhận mốc 1000k");
                                    break;
                            }
                        } else if (player.iDMark.getIndexMenu() == 5) {
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, 66, "|6|Đây là quà mốc tích lũy!\n" + "|7|Mốc 10K: 10V 3sao\n" + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND\n" + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!", "Nhận ngay", "Từ chối");
                                    break;
                                case 1:
                                    this.createOtherMenu(player, 77, "|6|Đây là quà mốc tích lũy!\n" + "|7|Mốc 20K: 20v 3sao\n" + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND\n" + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!", "Nhận ngay", "Từ chối");
                                    break;
                                case 2:
                                    this.createOtherMenu(player, 88, "|6|Đây là quà mốc tích lũy!\n" + "|7|Mốc 50K: Cải trang Zamatsu, Linh Thú, Tuần Lộc\n" + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND\n" + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!", "Nhận ngay", "Từ chối");
                                    break;
                                case 3:
                                    this.createOtherMenu(player, 99, "|6|Đây là quà mốc tích lũy!\n" + "|7|Mốc 100K: 1 Set Kích Hoạt thường, 3 bộ nro\n" + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND\n" + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!", "Nhận ngay", "Từ chối");
                                    break;
                                case 4:
                                    this.createOtherMenu(player, 100, "|6|Đây là quà mốc tích lũy!\n" + "|7|Mốc 200k: Kiếm, x99(cn,bh,gx,bk)\n" + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND\n" + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!", "Nhận ngay", "Từ chối");
                                    break;
                                case 5:
                                    this.createOtherMenu(player, 111, "|6|Đây là quà mốc tích lũy!\n" + "|7|Mốc 500K: Cải trang Obito lục đạo, x2000 viên đá các loại\n" + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND\n" + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!", "Nhận ngay", "Từ chối");
                                    break;
                                case 6:
                                    this.createOtherMenu(player, 122, "|6|Đây là quà mốc tích lũy!\n" + "|7|Mốc 1000K: Meow tà ác, cải trang Majin Form, Xe tăng, x99 3sao\n" + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + "VND\n" + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!", "Nhận ngay", "Từ chối");
                                    break;
                            }
                                ...
                                case 0:
                                    if (player.tongtien < 1000000) {
                                        ...
                                        if (player.flagMoc1cu == 0) {
                                            ...
                                            ct.itemOptions.add(new Item.ItemOption(50, Util.nextInt(75, 120)));
                                            ct.itemOptions.add(new Item.ItemOption(77, Util.nextInt(75, 120)));
                                            ct.itemOptions.add(new Item.ItemOption(103, Util.nextInt(75, 120)));
                                            ...
                                            meow.itemOptions.add(new Item.ItemOption(50, Util.nextInt(75, 120)));
                                            meow.itemOptions.add(new Item.ItemOption(77, Util.nextInt(75, 120)));
                                            meow.itemOptions.add(new Item.ItemOption(103, Util.nextInt(75, 120)));
                                            du.itemOptions.add(new Item.ItemOption(50, Util.nextInt(75, 120)));
                                            du.itemOptions.add(new Item.ItemOption(77, Util.nextInt(75, 120)));
                                            du.itemOptions.add(new Item.ItemOption(103, Util.nextInt(75, 120)));
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    item.itemOptions.add(new ItemOption(219, Util.nextInt(200, 350)));
                                    item.itemOptions.add(new ItemOption(221, Util.nextInt(200, 350)));
                                    item.itemOptions.add(new ItemOption(223, 1));
                                    InventoryServiceNew.gI().addItemBag(player, item);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn nhận được cải trang công đức cực VIP");
                                    player.congduc = sum;
                                    break;
                                case 1:
                                    ...
                                    Item gangCongDuc = ItemService.gI().createGangCongDuc(player.gender);
                                    InventoryServiceNew.gI().addItemBag(player, gangCongDuc);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn vừa nhận được một trang bị công đức VIP");
                                    // process here
                                    player.congduc = sum2;
                                    break;
                                case 2:
                                    ...
                                    // process here
                                    Item linhthu = ItemService.gI().createLinhThuCongDuc(player);
                                    InventoryServiceNew.gI().addItemBag(player, linhthu);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn vừa nhận được một linh thú công đức VIP");
                                    player.congduc = sum3;
                                ...
                                case 3:
                                    ...
                                    // process here
                                    Item deolung = ItemService.gI().createDeoLungCongDuc();
                                    InventoryServiceNew.gI().addItemBag(player, deolung);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn vừa nhận được một cánh công đức VIP");
                                    player.congduc = sum4;
                                    break;
                            }
                        }
                        ...
                        if (select == 0) {
                            ...
                            if (!TaiXiu.gI().baotri) {
                                ...
                                if (pl.goldTai == 0 && pl.goldXiu == 0) {
                                    ...
                                    createOtherMenu(pl, 1, "\n|7|---ĐỠ THẾ LỒN NÀO ĐƯỢC CÁC ÔNG À---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc" + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Hồng ngọc\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Xỉu : " + Util.format(pl.goldXiu) + " Công Đức" + "\n\n|7|Hệ thống sắp bảo trì", "Cập nhập", "Đóng");
                                }
                            }
                        }
                    } else if (pl.iDMark.getIndexMenu() == 1) {
                        if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.goldTai == 0 && pl.goldXiu == 0 && !TaiXiu.gI().baotri) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---ĐỠ THẾ LỒN NÀO ĐƯỢC CÁC ÔNG À---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Công Đức" + "\n|1|Tổng người đặt TÀI: " + TaiXiu.gI().PlayersTai.size() + " người" + "\n\n|6|Tổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Hồng ngọc" + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người" + "\n\n|5|Thời gian còn lại: " + time, "Cập nhập", "Theo TÀI", "Theo XỈU", "Đóng");
                                    break;
                                case 1:
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 0 || this.mapId == 7 || this.mapId == 14) {
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Hãy mang cho ta x20 mảnh SKH mỗi loại ta sẽ giúp ngươi đổi SKH", "Đổi SKH\n Trái Đất", "Đổi SKH\n Namec", "Đổi SKH\n Xayda");
                    } else {
...
//                                        throw new RuntimeException(e);
                                    ...
                                    if (manhSKHao == null || manhSKHquan == null || manhSKHgang == null || manhSKHgiay == null || manhSKHrada == null || manhSKHao.quantity < 20 || manhSKHquan.quantity < 20 || manhSKHgang.quantity < 20 || manhSKHgiay.quantity < 20 || manhSKHrada.quantity < 20) {
...
//                                        throw new RuntimeException(e);
                                    ...
                                    if (manhSKHao2 == null || manhSKHquan2 == null || manhSKHgang2 == null || manhSKHgiay2 == null || manhSKHrada2 == null || manhSKHao2.quantity < 20 || manhSKHquan2.quantity < 20 || manhSKHgang2.quantity < 20 || manhSKHgiay2.quantity < 20 || manhSKHrada2.quantity < 20) {
                                        this.npcChat(player, "Bạn không đủ vật phẩm");
                                    } else {
...
//                                        throw new RuntimeException(e);
                                    ...
                                    if (manhSKHao3 == null || manhSKHquan3 == null || manhSKHgang3 == null || manhSKHgiay3 == null || manhSKHrada3 == null || manhSKHao3.quantity < 20 || manhSKHquan3.quantity < 20 || manhSKHgang3.quantity < 20 || manhSKHgiay3.quantity < 20 || manhSKHrada3.quantity < 20) {
                                        this.npcChat(player, "Bạn không đủ vật phẩm");
                                    } else {
...
//
    ...
    public static Npc shopdevip(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU, "Xin chào, ta có một số vật phẩm đặt biệt cậu có muốn xem không?", "Đổ Đệ", "Đổi \nSkill Đệ", "Danh \nSách Boss", "Từ chối");
                }
            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            try (Connection con = GirlkunDB.getConnection();) {
                                switch (select) {
                                    ...
                                    case 3:
                                        if (player.congduc < 70000) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 70k công đức");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                                        ...
                                        player.congduc -= 70000;
                                        PetService.gI().createbumusic(player, player.pet != null, player.pet.gender);
                                        break;

                                    case 4:
                                        if (player.congduc < 150000) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 150k công đức");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                                        ...
                                        player.congduc -= 150000;
                                        PetService.gI().createngokhong(player, player.pet != null, player.pet.gender);
                                        break;
                                    case 5: //pazuzu
                                        if (player.congduc < 200000) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 200k công đức");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    createOtherMenu(player, ConstNpc.MENU_CHUYEN_HOA_TRANG_BI, "Ta sẽ biến trang bị mới cao cấp của ngươi\n" + "thành trang bị có cấp độ và sao pha lê của trang bị cũ", "Chuyển hóa\nDùng kim tệ", "Chuyển hóa\nDùng ngọc");
                                    break;
                                case 3:
                                    createOtherMenu(player, ConstNpc.PHAP_SU, "Ngươi tìm ta có việc gì?\n", "Nâng\ncấp", "Xóa\ndòng", "Hướng đẫn");
                                    break;
                                case 4:
                                    createOtherMenu(player, ConstNpc.NANG_CAP_TRANG_BI, "Ngươi tìm ta có việc gì?\n", "Hiến tế\n THẦN LINH", "Hiến tế\nHỦY DIỆT", "Chuyển hóa\nHỦY DIỆT", "Hướng dẫn");
                                    break;
                                case 5:
...
//                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.GIA_HAN_VAT_PHAM);
                                    break;
                                case 6:
                                    createOtherMenu(player, ConstNpc.TINH_AN_TRANG_BI, "Ngươi tìm ta có việc gì?\n", "Ấn trang bị", "Hướng dẫn");
                                    break;
                                case 7:
                                    Service.gI().sendThongBao(player, "Chức năng tạm đóng");
//                                    createOtherMenu(player, ConstNpc.SKH, "Ngươi tìm ta có việc gì?\n", "NÂNG CẤP\n(1)", "NÂNG CẤP\n(2)", "Từ Chối");
                                    break;
                                case 8:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NANG_CAP_CHAN_MENH);
                                    break;
                                case 9:
                                    createOtherMenu(player, ConstNpc.KHAM_DA, "Ngươi tìm ta có việc gì?\n", "Khảm HP", "Khảm Ki", "Khảm Dame", "Từ Chối");
                                    break;
                                case 10:
                                    createOtherMenu(player, ConstNpc.LUYEN_HOA, "Ngươi tìm ta có việc gì?\n", "Luyện\nLinh Thú", "Luyện\nPhụ Kiện", "Từ Chối");
                                    break;
                                case 11:
                                ...
                                case 12:
                                    ...
                                    break;
                                case 13:
                                    createOtherMenu(player, ConstNpc.NANG_SKH, "Ngươi tìm ta có việc gì?\n", "Nâng cấp\nSKH", "Nâng Level", "Kích hoạt thiên sứ", "Từ Chối");
                                    break;
                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_START_COMBINE) {
                            switch (player.combineNew.typeCombine) {
                        ...
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.NANG_SKH) {
                            switch (select) {
                                case 0:
...
//
                                    ...
                                    break;
                                case 2:
                                    createOtherMenu(player, ConstNpc.MENU_NANG_BONGTAI, "Ngươi muốn nâng bông tai à", "NÂNG CẤP\nPorata", "Mở chỉ số Porata", "Đóng");
                                    break;
                                case 3:
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NHAP_NGOC_RONG);
                                    break;
                                case 4:
                                    createOtherMenu(player, ConstNpc.SACH_TUYET_KY, "Ta có thể giúp gì cho ngươi ?", "Đóng thành\nSách cũ", "Đổi Sách\nTuyệt kỹ", "Giám định\nSách", "Tẩy\nSách", "Nâng cấp\nSách\nTuyệt kỹ", "Hồi phục\nSách", "Phân rã\nSách");
                                    break;
                            ...
                            switch (select) {
                                case 0://menu lựa chọn nâng cấp bông tai
                                    createOtherMenu(player, 55, "Ngươi muốn nâng bông tai à", "Nâng cấp\nPorata\n(1)", "Nâng cấp\nPorata\n(2)", "Nâng cấp\nPorata\n(3)");
                                    break;
                                case 1:
                                    createOtherMenu(player, 66, "Ngươi muốn mở chỉ số bông tai à\n" + "|1|Ngươi chỉ có thể mở chỉ số bông tai Cấp 4\n" + "|7|Ngươi có muốn thực hiện không?", "Thực hiện", "Đóng");
                                    break;
                            }
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if ((trangSachCu != null && trangSachCu.quantity >= 9999) && (biaSach != null && biaSach.quantity >= 1)) {
                                        ...
                                        createOtherMenu(player, ConstNpc.DONG_THANH_SACH_CU_2, NpcSay, "Từ chối");
                                        break;
                                    }
                                case 1:
                                    ...
                                    if ((cuonSachCu != null && cuonSachCu.quantity >= 10) && (kimBam != null && kimBam.quantity >= 1)) {
                                        createOtherMenu(player, ConstNpc.DOI_SACH_TUYET_KY, "|2|Đổi sách tuyệt kỹ 1\n" + "|1|Cuốn sách cũ " + cuonSachCu.quantity + "/10\n" + "Kìm bấm giấy " + kimBam.quantity + "/1\n" + "Tỉ lệ thành công: 20%\n", "Đồng ý", "Từ chối");
                                        break;
                                    } else {
                                        ...
                                        NpcSay += "|7|Tỉ lệ thành công: 20%\n";
                                        createOtherMenu(player, ConstNpc.DOI_SACH_TUYET_KY_2, NpcSay, "Từ chối");
                                    }
                                    break;
                                ...
                                case 5:// phục hồi sách
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.PHUC_HOI_SACH);
                                    break;
                                case 6:// phân rã sách
    ...
    public static Npc duongtank(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (mapId == 0) {
                        this.createOtherMenu(player, 0, "A mi phò phò,thí chủ hãy giúp giải cứu đồ đệ của bần tăng đang bị phong ấn tại ngũ hành sơn, chỉ hỗ trợ từ 100 triệu sức mạnh trở lên mới có thể vào, phí vào là 500 ruby.", "Vào Ngay", "Từ chối");
                    }
                    if (mapId == 122) {
                    ...
                    if (mapId == 124) {
                        this.createOtherMenu(player, 0, "A mi phò phò, thí chủ hãy thu thập bùa 'giải khai phong ấn', mỗi chữ 10 cái.", "Đổi đào chín", "Giải phong ấn", "Từ chối");
                    }
                }
            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (mapId == 0 || mapId == 182) {
                        switch (select) {
                            case 0:
                                if (player.nPoint.power < 100000000) {
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (item == null || item.quantity < 10) {
                                    npcChat(player, "Cần 10 quả đào xanh để đổi lấy ấn chú từ bần tăng.");
                                    return;
                                }
                                if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                ...
                                int[] phus = {537, 538, 539, 540};
                                int rad = Util.nextInt(0, phus.length - 1);

                                Item newItem = ItemService.gI().createNewItem((short) phus[rad], 1);
                                InventoryServiceNew.gI().subQuantityItemsBag(player, item, 10);
                                InventoryServiceNew.gI().addItemBag(player, newItem, 0);
                                InventoryServiceNew.gI().sendItemBags(player);
                                npcChat(player, "Ta đã đổi cho thí chủ rồi đó, hãy mang đi giải phong ấn nào.");
                                Service.gI().sendThongBao(player, "Bạn nhận đuọc " + newItem.template.name);
                                break;
...
//                                        throw new RuntimeException(e);
                                ...
                                if (khai == null || khai.quantity < 9) {
                                    this.npcChat(player, "Bạn không đủ x9 Chữ Khai");
                                } else if (giai == null || giai.quantity < 9) {
                                    this.npcChat(player, "Bạn không đủ x9 Chữ Giải");
                                } else if (phong == null || phong.quantity < 9) {
                                    this.npcChat(player, "Bạn không đủ x9 Chữ Phong");
                                } else if (an == null || an.quantity < 9) {
                                    this.npcChat(player, "Bạn không đủ x9 Chữ Ấn");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                    this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                } else {
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, khai, 9);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, giai, 9);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, phong, 9);
                                    InventoryServiceNew.gI().subQuantityItemsBag(player, an, 9);

                                    Service.getInstance().sendMoney(player);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    int randomItem = Util.nextInt(3);
                                    int randomUtil = 100;
                                    if ((randomItem == 2 || randomItem == 3) && Util.isTrue(5, 20)) {
                                        randomUtil = Util.nextInt(100, 200);
                                    }
                                    if ((randomItem == 2 || randomItem == 3) && Util.isTrue(5, 40)) {
                                        randomUtil = Util.nextInt(2, 300);
                                    }
                                    if ((randomItem == 2 || randomItem == 3) && Util.isTrue(5, 60)) {
                                        randomUtil = Util.nextInt(2, 500);
                                    }

                                    if (randomItem == 0) {
                                        Item VatPham = ItemService.gI().createNewItem((short) (547));
                                        VatPham.itemOptions.add(new Item.ItemOption(50, Util.nextInt(99, 300)));
                                        ...
                                        VatPham.itemOptions.add(new Item.ItemOption(93, 3));
                                        ...
                                        VatPham.itemOptions.add(new Item.ItemOption(50, 300));
                                        VatPham.itemOptions.add(new Item.ItemOption(77, Util.nextInt(120, 300)));
                                        VatPham.itemOptions.add(new Item.ItemOption(103, 10));
                                        VatPham.itemOptions.add(new Item.ItemOption(14, 5));
                                        VatPham.itemOptions.add(new Item.ItemOption(93, 3));
                                        InventoryServiceNew.gI().addItemBag(player, VatPham);
                                        ...
                                        Item VatPham = ItemService.gI().createNewItem((short) (547));
                                        VatPham.itemOptions.add(new Item.ItemOption(50, randomUtil));
                                        VatPham.itemOptions.add(new Item.ItemOption(77, 300));
                                        VatPham.itemOptions.add(new Item.ItemOption(103, 10));
                                        VatPham.itemOptions.add(new Item.ItemOption(14, 5));
                                        InventoryServiceNew.gI().addItemBag(player, VatPham);
                                        createOtherMenu(player, ConstNpc.IGNORE_MENU, "ta tặng cải trang ngộ không", "Ok");
                                        ...
                                        Item VatPham = ItemService.gI().createNewItem((short) (548));
                                        VatPham.itemOptions.add(new Item.ItemOption(50, 150));
                                        VatPham.itemOptions.add(new Item.ItemOption(77, randomUtil));
                                        VatPham.itemOptions.add(new Item.ItemOption(103, 10));
                                        VatPham.itemOptions.add(new Item.ItemOption(14, 5));
            ...
            public void confirmMenu(Player player, int select) {
                if (this.mapId == 102) {
                    ...
                    if (select == 0) {
                        ...
                        Service.gI().sendThongBaoOK(player, "Bạn đã gây " + player.damethanmeo + " Sát thương" + "\nBạn đã gây " + player.ptdame + "% Sát thương");
                    } else if (select == 1) {
                        //đến tương lai
                        changeMap();
                        if (TaskService.gI().getIdTask(player) >= ConstTask.TASK_20_0) {
...
//                    if (pl.iDMark.getIndexMenu() == 0) {
//                        if (select == 0) {
//                            createOtherMenu(pl, ConstNpc.IGNORE_MENU, "Thời gian giữa các giải là 5 phút\nKhi hết giờ, hệ thống sẽ ngẫu nhiên chọn ra 1 người may mắn.\nLưu ý: Số thỏi kim tệ nhận được sẽ bị nhà cái lụm đi 5%!Trong quá trình diễn ra khi đặt cược nếu thoát game mọi phần đặt đều sẽ bị hủy", "Ok");
//                        } else if (select == 1) {
...
//                                            createOtherMenu(pl, 1, "Tổng giải thường: " + ChonAiDay.gI().goldNormar + " thỏi kim tệ, cơ hội trúng của bạn là: " + pl.percentGold(0) + "%\nTổng giải VIP: " + ChonAiDay.gI().goldVip + " thỏi kim tệ, cơ hội trúng của bạn là: " + pl.percentGold(1) + "%\nSố thỏi kim tệ đặt thường: " + pl.goldNormar + "\nSố thỏi kim tệ đặt VIP: " + pl.goldVIP + "\n Thời gian còn lại: " + time, "Cập nhập", "Thường\n20 thỏi\nvàng", "VIP\n200 thỏi\nvàng", "Đóng");
//                                        } else {
//                                            Service.gI().sendThongBao(pl, "Bạn không đủ thỏi kim tệ");
//
//                                        }
//                                    } catch (Exception ex) {
                ...
                if (player.iDMark.isBaseMenu()) {
                    switch (select) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3: // chọn ai đây
                            createOtherMenu(player, ConstNpc.CHON_AI_DAY, "Trò chơi Chọn Ai Đây đang được diễn ra, nếu bạn tin tưởng mình đang tràn đầy " + "may mắn thì có thể tham gia thử", "Thể lệ", "Chọn\nVàng", "Chọn\nhồng ngọc", "Chọn\nngọc xanh");
                            break;
                    }
...
//                        }
            ...
            private void xửLýLựaChọnMiniGame_Gold(Player player) {
                ...
                String npcSay = "" + "Kết quả giải trước: " + KQ + "\n" + (previousResults.toString() != "" ? previousResults.toString() + "\n" : "") + "Tổng giải thưởng: " + Money + " thỏi kim tệ\n" + "<" + second + ">giây\n" + (number != "" ? "Các số bạn chọn: " + number : "");
                String[] Menus = {"Cập nhật", "1 Số\n 1 thỏi kim tệ", "Ngẫu nhiên\n1 số lẻ\n 1 thỏi kim tệ", "Ngẫu nhiên\n1 số chẵn\n 1 thỏi kim tệ", "Hướng\ndẫn\nthêm", "Đóng"};
            ...
            private void xửLýChonAiDay(Player player, int select, String time) {
                switch (select) {
                    case 0:
                        ...
                        break;
                    case 1:
                        createOtherMenu(player, ConstNpc.CHON_AI_DAY_VANG, "Tổng giải thường: " + Util.numberToMoney(ChonAiDay_Gold.gI().goldNormar) + " kim tệ, cơ hội trúng của bạn là: " + player.percentGold(0) + "%\n" + "Tổng giải VIP: " + Util.numberToMoney(ChonAiDay_Gold.gI().goldVip) + " kim tệ, cơ hội trúng của bạn là: " + player.percentGold(1) + "%\n" + "Thời gian còn lại: " + time, "Cập nhập", "Thường\n1 triệu\nvàng", "VIP\n10 triệu\nvàng", "Đóng");
                        break;
                    case 2:
            ...
            private void xửLýThuong1TrieuVang(Player player) {
                try {
                    ...
                    if (player.inventory.gold >= 1_000_000) {
                        ...
                        Service.gI().sendThongBao(player, "Bạn không đủ kim tệ");
                    }
                } catch (Exception ex) {
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void confirmMenu(Player pl, int select) {
                if (canOpenNpc(pl)) {
                    ...
                    if (pl.iDMark.getIndexMenu() == 0) {
                        if (select == 0) {
                            createOtherMenu(pl, ConstNpc.IGNORE_MENU, "|5|Có 2 nhà cái Tài và Xĩu, bạn chỉ được chọn 1 nhà để tham gia" + "\n\n|6|Sau khi kết thúc thời gian đặt cược. Hệ thống sẽ tung xí ngầu để biết kết quả Tài Xỉu" + "\n\nNếu Tổng số 3 con xí ngầu <=10 : XỈU\nNếu Tổng số 3 con xí ngầu >10 : TÀI\nNếu 3 Xí ngầu cùng 1 số : TAM HOA (Nhà cái lụm hết)" + "\n\n|7|Lưu ý: Số Công Đức nhận được sẽ bị nhà cái lụm đi 20%. Thắng sẽ x2,3 số công đức. Trong quá trình diễn ra khi đặt cược nếu thoát game trong lúc phát thưởng phần quà sẽ bị HỦY", "Ok");
                        } else if (select == 1) {
                            if (!TaiXiu.gI().baotri) {
                                if (pl.goldTai == 0 && pl.goldXiu == 0) {
                                ...
                                if (pl.goldTai == 0 && pl.goldXiu == 0) {
                                    ...
                                    createOtherMenu(pl, 1, "\n|7|---TÀI XỈU NGỌC RỒNG---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Công Đức" + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Công Đức\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Xỉu : " + Util.format(pl.goldXiu) + " Công Đức" + "\n\n|7|Hệ thống sắp bảo trì", "Cập nhập", "Đóng");
                                }
                            }
                        }
                    } else if (pl.iDMark.getIndexMenu() == 1) {
                            ...
                            switch (select) {
                                ...
                                case 1:
                                    if (pl.congduc >= 1000) {
                                        ...
                                        Service.gI().sendThongBao(pl, "Công đức của bạn cần ít nhất 1.000 để tham gia đánh tài xỉu");
                                    }
                                    break;
                                case 2:
                                    if (pl.congduc >= 1000) {
                                        ...
                                        Service.gI().sendThongBao(pl, "Công đức của bạn cần ít nhất 1000 để tham gia đánh tài xỉu");
                                    }
                                    break;
                            }
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.goldTai > 0 && !TaiXiu.gI().baotri) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---TÀI XỈU NGỌC RỒNG---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Công Đức" + "\n|1|Tổng người đặt TÀI: " + TaiXiu.gI().PlayersTai.size() + " người" + "\n\n|6|Tổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Công Đức" + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người" + "\n\n|5|Thời gian còn lại: " + time, "Cập nhập", "Theo TÀI", "Theo XỈU", "Đóng");
                        ...
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.goldXiu > 0 && !TaiXiu.gI().baotri) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---TÀI XỈU NGỌC RỒNG---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Công Đức" + "\n|1|Tổng người đặt TÀI: " + TaiXiu.gI().PlayersTai.size() + " người" + "\n\n|6|Tổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Công Đức" + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người" + "\n\n|5|Thời gian còn lại: " + time, "Cập nhập", "Theo TÀI", "Theo XỈU", "Đóng");
                                    break;
                        ...
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.goldXiu == 0 && pl.goldTai == 0 && TaiXiu.gI().baotri) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---TÀI XỈU NGỌC RỒNG---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Công Đức" + "\n|1|Tổng người đặt TÀI: " + TaiXiu.gI().PlayersTai.size() + " người" + "\n\n|6|Tổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Công Đức" + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người" + "\n\n|5|Thời gian còn lại: " + time, "Cập nhập", "Theo TÀI", "Theo XỈU", "Đóng");
...
//                                    if (player.iDMark.getIndexMenu() == 0) {
//                                        player.typeInput = 20;
//                                        Service.gI().sendInputText(player, "Hãy chọn 1 số từ " + MiniGame.gI().MiniGame_S1.min + "-" + MiniGame.gI().MiniGame_S1.max + ", giá 50 thỏi kim tệ", 1, new int[]{1}, new String[]{"Số bạn chọn"});
//                                    }
//                                    break;
                                ...
                                case 2:
                                    if (player.clan != null) {
                                        if (player.clan.ConDuongRanDoc != null) {
                                            this.createOtherMenu(player, ConstNpc.MENU_OPENED_CDRD, "Bang hội của con đang đi con đường rắn độc cấp độ " + player.clan.ConDuongRanDoc.level + "\nCon có muốn đi theo không?", "Đồng ý", "Từ chối");
                                        } else {

                                            this.createOtherMenu(player, ConstNpc.MENU_OPEN_CDRD, "Đây là Con đường rắn độc \nCác con cứ yên tâm lên đường\n" + "Ở đây có ta lo\nNhớ chọn cấp độ vừa sức mình nhé", "Chọn\ncấp độ", "Từ chối");
                                        }
                                    } else {
                            ...
                            switch (select) {
                                case 0:
                                    if (player.clan.haveGoneConDuongRanDoc) {
                                        createOtherMenu(player, ConstNpc.IGNORE_MENU, "Bang hội của ngươi đã đi con đường rắn độc lúc " + TimeUtil.formatTime(player.clan.lastTimeOpenConDuongRanDoc, "HH:mm:ss") + " hôm nay. Người mở\n" + "(" + player.clan.playerOpenConDuongRanDoc.name + "). Hẹn ngươi quay lại vào ngày mai", "OK", "Hướng\ndẫn\nthêm");
                                        return;
    ...
    public static Npc docNhan(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (player.clan == null) {
                        this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Chỉ tiếp các bang hội, miễn người không vào bang", "Đóng");
                        return;
                    }
                    ...
                    if (flag) {
                        ...
                        createOtherMenu(player, ConstNpc.IGNORE_MENU, "Hãy tiêu diệt hết quái và boss trong map", "OK");
                    }
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    if (player.clan.getMembers().size() < DoanhTrai.N_PLAYER_CLAN) {
                        this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Bang hội phải có ít nhất 3 thành viên mới có thể mở", "Đóng");
                        return;
                    }
                            ...
                            case 1:
                                if (player.clan != null) {
                                    if (player.clan.khiGas != null) {
                                        this.createOtherMenu(player, ConstNpc.MENU_OPENED_GAS, "Bang hội của con đang đi DesTroy Gas cấp độ " + player.clan.khiGas.level + "\nCon có muốn đi theo không?", "Đồng ý", "Từ chối");
                                    } else if (player.clan.haveGoneGas) {
                                        createOtherMenu(player, ConstNpc.IGNORE_MENU, "Bang hội của ngươi đã đi Khí gas hủy diệt lúc " + TimeUtil.formatTime(player.clan.timeOpenKhiGas, "HH:mm:ss") + " hôm nay. Người mở\n" + "(" + player.clan.playerOpenKhiGas.name + "). Hẹn ngươi quay lại vào ngày mai", "OK", "Hướng\ndẫn\nthêm");
                                        return;
                                    } else {
                                        this.createOtherMenu(player, ConstNpc.MENU_OPEN_GAS, "Khí Gas Huỷ Diệt đã chuẩn bị tiếp nhận các đợt tấn công của quái vật\n" + "các con hãy giúp chúng ta tiêu diệt quái vật \n" + "Ở đây có ta lo\nNhớ chọn cấp độ vừa sức mình nhé", "Chọn\ncấp độ", "Từ chối");
                                    }
                                } else {
                                    this.npcChat(player, "Con phải có bang hội ta mới có thể cho con đi");
                                }
...
//                                        return;
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == (21 + player.gender)) {
                        ...
                        if (player.mabuEgg.getSecondDone() != 0) {
                            this.createOtherMenu(player, ConstNpc.CAN_NOT_OPEN_EGG, "Burk Burk...", "Hủy bỏ\ntrứng", "Ấp nhanh\n" + Util.numberToMoney(COST_AP_TRUNG_NHANH) + " kim tệ", "Đóng");
                        } else {
                            ...
                            case ConstNpc.CAN_NOT_OPEN_EGG:
                                if (select == 0) {
                                    ...
                                    if (player.inventory.gold >= COST_AP_TRUNG_NHANH) {
                                        ...
                                        Service.gI().sendThongBao(player, "Bạn không đủ kim tệ để thực hiện, còn thiếu " + Util.numberToMoney((COST_AP_TRUNG_NHANH - player.inventory.gold)) + " kim tệ");
                                    }
                                }
                                break;
                    ...
                    if (this.mapId == 154) {
                        switch (player.iDMark.getIndexMenu()) {
                            case ConstNpc.CAN_NOT_OPEN_BILL:
                                if (select == 0) {
                                    this.createOtherMenu(player, ConstNpc.CONFIRM_DESTROY_BILL, "Bạn có chắc chắn muốn hủy bỏ trứng Bill?", "Đồng ý", "Từ chối");
                                } else if (select == 1) {
                                    if (player.inventory.gold >= COST_AP_TRUNG_NHANH) {
                                        player.inventory.gold -= COST_AP_TRUNG_NHANH;
    ...
    public static Npc quocVuong(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            @Override
            public void openBaseMenu(Player player) {
                this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ta sẽ nâng cấp cảnh giới cho con", "Bản thân", "Đệ tử", "Bản nguyên", "Hợp nhất", "Từ chối");
            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                if (player.nPoint.limitPower < NPoint.MAX_LIMIT && player.nPoint.canOpenByNpc()) {
                                    this.createOtherMenu(player, ConstNpc.OPEN_POWER_MYSEFT, "Ta sẽ truyền công giúp con đột phá , con đã chuẩn bị đủ nguyên liệu chưa?" + Util.numberToMoney(player.nPoint.getPowerNextLimit()), "Bế quan đột phá", "Đột phá ngay\n" + Util.numberToMoney(OpenPowerService.COST_SPEED_OPEN_LIMIT_POWER) + " kim tệ", "Đóng");
                                } else {
                                    this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Muốn tăng cảnh giới cao hơn phải dựa vào bản thân con rồi", "Đóng");
                                }
                                break;
                            case 1:
                                if (player.pet != null) {
                                    if (player.pet.nPoint.limitPower < NPoint.MAX_LIMIT && player.pet.nPoint.canOpenByNpc()) {
                                        this.createOtherMenu(player, ConstNpc.OPEN_POWER_PET, "Ta sẽ truyền công giúp đệ tử con đột phá" + Util.numberToMoney(player.pet.nPoint.getPowerNextLimit()), "Đột phá ngay\n" + Util.numberToMoney(OpenPowerService.COST_SPEED_OPEN_LIMIT_POWER) + " kim tệ", "Đóng");
                                    } else {
                                        this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Muốn đột phá đến cảnh giới cao hơn hãy tìm thần hủy diệt ta bất lực rồi", "Đóng");
                                    }
                                } else {
                                    Service.gI().sendThongBao(player, "Không thể thực hiện");
                                }
                            ...
                            case 3:
                                if (player.pet != null) {
                                    if (player.pet.nPoint.limitPower < NPoint.MAX_LIMIT) {
                                        this.createOtherMenu(player, ConstNpc.OPEN_POWER_HOP_NHAT, "|3|CHÀO CON!\n|5|--CON CÓ MUỐN THÔN PHỆ ĐỆ TỬ--" + "\n|1|ĐỂ GIA TĂNG SỨC MẠNH BẢN THÂN HAY KHÔNG?" + "\n|1|CON SẼ MẤT 30 TỈ SỨC MẠNH VÀ ĐỆ TỬ CỦA CON!!!" + "\n|1|CHỈ SỐ GỐC SẼ SẼ ĐƯỢC CỘNG NGẪU NHIÊN CHO CON" + "\n|7|Yêu Cầu:" + Util.getFormatNumber(player.pet.nPoint.power) + "/" + "1.000.000.000 sức mạnh", "HI SINH ĐỆ TỬ", "từ chối");
                                    }
                                }
                                //giới hạn đệ tử
                                break;
...
//                                        throw new RuntimeException(e);
                                ...
                                if (dt == null || dt.quantity < 1) {
                                ...
                                } else if (player.pet.nPoint.power < 100000000) {
                                    Service.gI().sendThongBao(player, "|2|YÊU CẦU ĐỆ TỬ PHẢI ÍT NHẤT 100 TRIỆU SM NHÉ !");
                                } else if (player.nPoint.power < 40000000000L) {
                                    Service.gI().sendThongBao(player, "|2|YÊU CẦU SƯ PHỤ TRÊN 40 TỈ  TỈ SM NHÉ !");
                                } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                    this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                } else {
                                    int tyLeBanNguyen = 1;
                                    ...
                                    // ty le cong chi so
                                    tyLeBanNguyen = (int) player.pet.nPoint.power / 100000000;
                        ...
                        switch (select) {
                            ...
                            case 1:
                                if (player.inventory.gold >= OpenPowerService.COST_SPEED_OPEN_LIMIT_POWER) {
                                    ...
                                    Service.gI().sendThongBao(player, "Bạn không đủ kim tệ để mở, còn thiếu " + Util.numberToMoney((OpenPowerService.COST_SPEED_OPEN_LIMIT_POWER - player.inventory.gold)) + " kim tệ");
                                }
                                break;
                        }
    ...
    public static Npc Gojo(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ta có thể giúp gì cho ngươi ?", "Đến Map Leo Tháp");
                    } else if (this.mapId == 181) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ngươi muốn tiếp tục leo tháp chứ!\n Tháp hiện tại của ngươi là :" + player.capboss, "Thách Đấu", "Xem Top Lep Tháp", "Về Đảo Kame", "Từ chối");
                    }
                }
            }
...
//                                double dk = (player.xuatsu + 1) * 10;
                                        ...
                                        long hptong = (player.nPoint.hpMax + hp) * dk * (player.capboss >= 5 ? 2 * dk : 1);
                                        BossData bossDataClone = new BossData("Yaritobe Super Red [Lv: " + player.capboss + "]", ConstPlayer.NAMEC, new short[]{1441, 1442, 1443, player.getFlagBag(), player.idAura, player.getEffFront()}, 10_000 * dk, new long[]{10_000_000 * dk}, new int[]{174}, new int[][]{{Skill.LIEN_HOAN, 7, 500}, {Skill.MASENKO, 7, 3000}, {Skill.DICH_CHUYEN_TUC_THOI, 7, 60000}, {Skill.BIEN_KHI, 1, 60000}}, new String[]{"|-2|Ta sẽ tiêu diệt ngươi"}, // text
                                                // chat 1
                                                new String[]{"|-1|Ta Sẽ đập nát đầu ngươi!"}, // text chat 2
                                                new String[]{"|-1|Hẹn người lần sau"}, // text chat 3
                                                1);
                                        try {
                                            new ThachDauGoJo(Util.createIdBossLV(player.id), bossDataClone, player.zone, player.name, player.capboss, player);
...
//                                } else
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.getIndexMenu() == ConstNpc.MENU_PHU_HP) {
                        if (select == 0) {
                            this.createOtherMenu(player, ConstNpc.MENU_OPTION_PHU_HP, "Ta sẽ giúp ngươi tăng HP lên mức kinh hoàng, ngươi chọn đi", "x3 HP\n" + Util.numberToMoney(BlackBallWar.COST_X3) + " kim tệ", "x5 HP\n" + Util.numberToMoney(BlackBallWar.COST_X5) + " kim tệ", "x7 HP\n" + Util.numberToMoney(BlackBallWar.COST_X7) + " kim tệ", "Từ chối");
                        }
    ...
    public static Npc npcThienSu64(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                ...
                if (this.mapId == 48) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "Đã tìm đủ nguyên liệu cho tôi chưa?\n Tôi sẽ giúp cậu mạnh lên kha khá đấy!", "Hướng Dẫn", "Đổi Thức Ăn\nLấy Điểm", "Từ Chối");
                }
                if (this.mapId == 154) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "Đã tìm đủ nguyên liệu cho tôi chưa?\n Tôi sẽ giúp cậu mạnh lên kha khá đấy!", "Chế Tạo trang bị thiên sứ", "Cửa Hàng\nBán Ấy", "Địt Nhau");
                }
            }
    ...
    public static Npc bill(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU, "Gặp Whis Để Đổi Thức Ăn Lấy Điểm Sau Đó Gặp Ta Để Mua Trang Bị Hủy Diệt", "Điểm", "Shop Hủy Diệt", "Đóng");
                }
            }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (this.mapId == 154) {
                    ...
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ngươi tìm ta có việc gì?", "Hiến tế\nThần linh", "Hướng\ndẫn", "Đóng");
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        if (this.mapId == 47 || this.mapId == 84) {
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào bạn \btôi có thể giúp bạn làm nhiệm vụ", "Nhiệm vụ\nhàng ngày", "Nhận ngọc\nmiễn phí", "Từ chối");
                        }
//                    if (this.mapId == 47) {
//                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                        ...
                        switch (select) {
                            ...
                            case 1:
                                if (player.inventory.ruby < 200) {
                                    Service.gI().sendThongBao(player, "|7|Bạn không đủ 200 Hồng ngọc");
                                    return;
                                }
    ...
    public static Npc Daishinkan(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            public void chatWithNpc(Player player) {
                ...
                String[] chat = {"|7|Đua Top Ngọc Rồng"};
            ...
            public void openBaseMenu(Player player) {
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 14 || this.mapId == 7 || this.mapId == 0) {
                        createOtherMenu(player, ConstNpc.BASE_MENU, "Tính mở đua TOP mà lười quá =))", "Top\nSức mạnh", "Từ chối");
                    }
                }
            }
                    ...
                    if (this.mapId == 14 || this.mapId == 7 || this.mapId == 0) {
                        ...
                        switch (select) {
                            case 0:
                                ...
                                break;
                            case 1:
                                Service.getInstance().sendThongBaoOK(player, TopService.getTopNapQua());
                                break;
                        }
                    }
                }
    ...
    public static Npc NPC_cadic(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 48) {
                        createOtherMenu(player, ConstNpc.BASE_MENU, "|2|Ta Vừa Hack Được Top Của Toàn Server\b|7|Mi Muống Xem Tóp Gì?", "Top\nSức Mạnh", "Từ chối");
                    }
                }
            }
    ...
    public static Npc franky(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                ...
                if (canOpenNpc(player)) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào anh, bọn em đang cần 1 số lượng cá rất lớn. Anh có thể giúp bọn em câu cá được không?", "Hướng dẫn", "Cửa hàng\nDụng cụ", "Của hàng\nCá", "Nâng cấp cần câu", "Sửa cần câu");
                }
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NANG_CAP_CAN_CAU);
                                break;
                            case 4:
                                CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.SUA_CHUA_CAN_CAU);
                                break;
                        }
                    } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_START_COMBINE) {
                        switch (player.combineNew.typeCombine) {
            ...
            public void openBaseMenu(Player pl) {
                if (canOpenNpc(pl)) {
                    if (this.map.mapId == 52) {
                        ...
                        int goldchallenge = pl.goldChallenge;
                        if (pl.levelWoodChest == 0) {
                            menuselect = new String[]{"Thi đấu\n" + Util.numberToMoney(goldchallenge) + " kim tệ", "Về\nĐại Hội\nVõ Thuật"};
                        } else {
...
//                                    if (DaiHoiService.gI().canRegisDHVT(player.nPoint.power)) {
                                    if (DaiHoiManager.gI().lstIDPlayers.size() < 256) {
                                        if (DaiHoiManager.gI().typeDHVT == (byte) 5 && player.inventory.gold >= 10000) {
                                            ...
                                            Service.getInstance().sendThongBao(player, "Không đủ kim tệ ngọc để đăng ký thi đấu");
                                        }
                                    } else {
    ...
    public static Npc unkonw(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, 0, "Éc éc Bạn muốn gì ở tôi :3?", "Đến Võ đài Unknow");
                    }
                    if (this.mapId == 112) {
    ...
    public static Npc vip_truongchimto(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 181) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ngươi tìm ta có việc gì?", "Thức Tỉnh");
                    }
                }
            }
    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            switch (tempId) {
                ...
                case ConstNpc.suphu:
                    return SuPhu(mapId, status, cx, cy, tempId, avatar);
                case ConstNpc.DENDE:
            ...
            public void confirmMenu(Player player, int select) {
                switch (player.iDMark.getIndexMenu()) {
                    ...
                    case ConstNpc.MENU_OPTION_USE_ITEM2005:
                        ...
                        break;
                    case ConstNpc.MENU_HOP_TL:
                        if (select == 0) {
                            IntrinsicService.gI().dotltd(player);
                        } else if (select == 1) {
                            IntrinsicService.gI().dotlnm(player);
                        } else if (select == 2) {
                            IntrinsicService.gI().dotlxd(player);
                        }
                        break;

                    case ConstNpc.menutltd:
                        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 6) {
                            Item hoptl = InventoryServiceNew.gI().findItemBag(player, (short) 1573);
                            ...
                            InventoryServiceNew.gI().addItemBag(player, ao);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được " + ao.template.name);
                            ...
                            InventoryServiceNew.gI().addItemBag(player, quan);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được " + quan.template.name);
                            ...
                            InventoryServiceNew.gI().addItemBag(player, gang);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được " + gang.template.name);
                            ...
                            InventoryServiceNew.gI().addItemBag(player, giay);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được " + giay.template.name);
                            ...
                            Service.gI().sendThongBao(player, "Bạn đã nhận được " + nhan.template.name);
                            InventoryServiceNew.gI().subQuantityItemsBag(player, hoptl, 1);
                            InventoryServiceNew.gI().sendItemBags(player);
                        } else {
                            Service.gI().sendThongBao(player, "Bạn không đủ 6 ô trống trong hành trang");
                        }
                        break;
                    case ConstNpc.menutlnm:
                        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 6) {
                            Item hoptl = InventoryServiceNew.gI().findItemBag(player, (short) 1573);
                    ...
                    case ConstNpc.MUA_DE:
                        switch (select) {
                            case 0:
                                this.createOtherMenu(player, ConstNpc.CONFIRM_MUA_DE_THIENTU, "Bạn có chắc muốn mua đệ Nguyệt Thần không?", "Đồng ý", "Không");
                                break;
                            case 1:
                                this.createOtherMenu(player, ConstNpc.CONFIRM_MUA_DE_BLACK, "Bạn có chắc muốn mua đệ Nhật Thần không?", "Đồng ý", "Không");
                                break;
                            case 2:
...
//                                    Service.gI().sendThongBao(player, "Quá giới hạn nhận Công Đức");
//                                    break;
//                                }
//                                player.inventory.ruby = 2000000;
//                                Service.gI().sendMoney(player);
//                                Service.gI().sendThongBao(player, "Nhận thành công 2 triệu Công Đức");
                                Service.gI().sendThongBao(player, "Chức năng hiện không hỗ trợ");
                                break;
                            case 2:
                                Item thoivang = null;
                                try {
...
//                                    }
                    ...
                    case ConstNpc.MENU_ADMIN:
                        switch (select) {
                            case 0:
                                this.createMenuConMeo(player, ConstNpc.ADMIN1, 30046, "|7| Admin Ngọc Rồng Online\b|2| barcoll\b|4| Người Đang Chơi: " + Client.gI().getPlayers().size() + "\n" + "|8|Current thread: " + (Thread.activeCount() - ServerManager.gI().threadMap) + "\n", "Ngọc Rồng", "Đệ Tử", "Bảo Trì", "Tìm Kiếm\nPlayer", "Chat all", "Đóng");
                                break;
                            case 1:
                                this.createOtherMenu(player, ConstNpc.CALL_BOSS, "Chọn Boss?", "Full Cụm\nANDROID", "BLACK", "BROLY", "Cụm\nCell", "Cụm\nDoanh trại", "DOREMON", "FIDE", "FIDE\nBlack", "Cụm\nGINYU", "Cụm\nNAPPA", "Gắp Thú");
                                break;
                            case 2:
                                this.createOtherMenu(player, ConstNpc.BUFFITEM, "Buff Item", "Buff Item", "Item Option", "Buff Skh");
                                break;
                            case 3:
                        ...
                        switch (select) {
                            case 0:
                                ...
                                if (player.getSession().coinBar >= coin) {
                                    ...
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "bạn nhận được " + tv + " " + thoiVang.template.name + " và " + dans + " " + dns.template.name);
                                } else {
                                    Service.gI().sendThongBao(player, "Số tiền của bạn là " + player.getSession().coinBar + " không đủ để quy " + " đổi ");
                                }
                                break;
                            case 1:
                                coin = 20000;
                    ...
                    case ConstNpc.CONFIRM_ACTIVE:
                        switch (select) {
                            case 0:
                                ...
                                Service.gI().sendThongBao(player, "Bạn không có kim tệ\n Vui lòng lên  để nạp thỏi kim tệ");
                                break;
                        }
                        break;
