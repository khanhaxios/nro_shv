...
//            Service.gI().sendThongBaoOK(plKill, "\nBạn nhận được 10 Hộp Quà Phái Đẹp và 5 Long Châu do kết liễu Boss.");
            ...
            // roi am duong phu
            ItemMap amduongPhu = new ItemMap(this.zone, 2068, Util.nextInt(3), this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, amduongPhu);
        }
