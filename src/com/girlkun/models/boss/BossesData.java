...
//                    {Skill.KHIEN_NANG_LUONG, 7, 1000},
    ...
    public static final BossData BOSS_BANG_TINH = new BossData(
            ...
            new String[]{"|-2|Tái tạo, tái tạo nào..."}, // text chat 1
            new String[]{"|-1|Nghe nói ta giết ta sẽ rơi Âm Dương Phù"}, // text chat 2
            new String[]{"|-1|Ngươi định giết ta ư ...."}, // text chat 3
            REST_5_M
    );
    ...
    public static final BossData AN_TROM = new BossData(
            ...
            new int[]{5},
            new int[][]{
                    {Skill.THAI_DUONG_HA_SAN, 3, 200000}},
