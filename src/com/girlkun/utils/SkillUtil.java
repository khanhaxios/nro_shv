...
public class SkillUtil {
    ...
    public static int getTimetienhoa(int level) { //thời gian tồn tại tiến hóa
        return (level + 5) * 5000;
    }
...
//        return 10000;
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        } else if (id >= 1888 && id <= 1894) {
            return Skill.TIEN_HOA;
        } else if (id >= 1895 && id <= 1901) {
            return Skill.TIEN_HOA;
        } else if (id >= 1902 && id <= 1908) {
            return Skill.TIEN_HOA;
        } else if (id >= 1867 && id <= 1873) {
            return Skill.BIEN_BROLY;
        } else if (id >= 1874 && id <= 1880) {
            return Skill.BIEN_BROLY;
        } else if (id >= 1881 && id <= 1887) {
            return Skill.BIEN_BROLY;
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1888 && tempId <= 1894) {
            return getSkillbyId(pl, Skill.TIEN_HOA);
        } else if (tempId >= 1895 && tempId <= 1901) {
            return getSkillbyId(pl, Skill.TIEN_HOA);
        } else if (tempId >= 1902 && tempId <= 1908) {
            return getSkillbyId(pl, Skill.TIEN_HOA);
        }else if (tempId >= 1867 && tempId <= 1873) {
            return getSkillbyId(pl, Skill.BIEN_BROLY);
        }else if (tempId >= 1874 && tempId <= 1880) {
            return getSkillbyId(pl, Skill.BIEN_BROLY);
        }else if (tempId >= 1881 && tempId <= 1887) {
            return getSkillbyId(pl, Skill.BIEN_BROLY);
